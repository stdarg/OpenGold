...
void CharacterCreationView::refresh()
{
    ...
    if(step==CreationStep::training){
        presentation::refresh_training_controls(*this,*creator_,callable_mp(this,&CharacterCreationView::training_toggled),callable_mp(this,&CharacterCreationView::training_selected),[](std::string_view source){return gs(source);});
    ...
    get_node<Label>("WeaponLabel")->set_text(gs("Weapon "+std::to_string(a.combat_body+1)+" / 35"));
