...
| F07 | Persist spell grants, cantrips, books and prepared lists, starting with the existing Wizard spells. | Known/book/prepared/free-cast state is distinct and survives saves. Wizard learning/preparation controls are a follow-up; adapting Cleric and each other preparation policy is separate. |
...
I01–I04 are complete. Continue with **I05: preserve remaining turn resources after attacks**,
