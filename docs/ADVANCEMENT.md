...
their existing levels using the previous default choices. Rules module 0.6.5
accepts the supported 0.3.0–0.6.4 campaign identities; unrelated content identities
...
Standalone combat checkpoints use version 6 to retain second-level slots,
per-turn spell/feat usage, timed effects, presentation facing, and pending movement reactions.
The preceding 0.6.4 module has a specific [combat migration](RULES.md#library-boundary)
that cancels obsolete facing reactions without refunding resources. Other old
