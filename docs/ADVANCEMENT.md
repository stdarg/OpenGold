...
their existing levels using the previous default choices. Rules module 0.6.11
accepts the supported 0.3.0–0.6.10 campaign identities; unrelated content identities
...
Modules 0.6.4/0.6.5/0.6.6/0.6.7/0.6.8/0.6.9/0.6.10 have specific [combat migrations](RULES.md#library-boundary)
