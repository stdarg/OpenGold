...
Rules version 0.6.4 includes the Rogue/Monk weapon proficiency, death-save,
Constitution/HP-history and remaining-turn-resource corrections, and accepts
0.6.3 and earlier supported
