...
Rules version 0.6.13 includes the Rogue/Monk weapon proficiency, death-save,
...
0.6.12 and earlier supported campaign saves. HP migration preserves living deficits
...
checkpoints from modules 0.6.4/0.6.5/0.6.6/0.6.7/0.6.8/0.6.9/0.6.10/0.6.11/0.6.12 migrate with matching content or a [verified preceding pack](DAMAGE.md), canceling only obsolete
