...
Rules version 0.6.10 includes the Rogue/Monk weapon proficiency, death-save,
...
0.6.9 and earlier supported campaign saves. HP migration preserves living deficits
...
checkpoints from modules 0.6.4/0.6.5/0.6.6/0.6.7/0.6.8/0.6.9 migrate with identical content, canceling only obsolete
facing reactions; see [combat persistence](RULES.md#library-boundary). Combat format 9 also retains Hit Dice; see [rest resources](REST-RESOURCES.md). Other older
