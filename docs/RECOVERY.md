...
Combat checkpoint format is version 7 and the combat module identity is
**0.6.6**. Supported older campaign saves migrate. Combat saves from modules 0.6.4/0.6.5
