...
struct SaveCodec {
    ...
    void field(rules::AdvancementChoice& v){fields(v.feat,v.abilities,v.spells);if(version>=15)field(v.training);if(version>=16)field(v.spell_learning);}
