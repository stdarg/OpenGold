...
inline constexpr std::array spell_component_definitions{
    SpellComponents{"shocking_grasp",true,true},SpellComponents{"eldritch_blast",true,true},SpellComponents{"ray_of_frost",true,true},SpellComponents{"sacred_flame",true,true},SpellComponents{"fire_bolt",true,true},SpellComponents{"poison_spray",true,true},SpellComponents{"cure_wounds",true,true},
