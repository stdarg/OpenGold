...
GrantEffects validate_grants(std::span<const rules::FeatureGrant> grants,std::string_view klass,
    std::string_view race,std::string_view background,unsigned level,bool damage_traits=true,bool rush_trait=true,bool action_surge=true,bool archery=true,bool starting_styles=true,bool tactical_mind=true);
