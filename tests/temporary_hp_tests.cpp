...
void actual_combat(){
    ...
    auto corrupt=saved;const auto at=corrupt.find(" 0 \"\" 0 0",corrupt.find("PC23"));check(at!=corrupt.npos,"Current actor has the empty pool suffix");corrupt.replace(at,9," -1 \"x\" 0 0");
