...
void campaign(){
    ...
    copy.complete_training(id,*srd5::character_rules(),{{"origin:languages",{"elvish","orc"}},{"class:fighter:fighting_style",{"archery"}}});copy.award_experience(900,"rush-xp");copy.advance(id,copy.default_advancement(id));
