...
The roster contains 72 independently composed portraits. The initial six were
approved for style, the next 30 established class coverage, and a further 36
expand the choices in every class. These files are
...
from interchangeable heads and bodies. Each of the 12 classes has six portraits: two Female,
two Male, and two Nonbinary. All nine in-game races appear in the expansion.
...
interpretations. All use the built-in image generator. The
...
remain the same. The four added Orcs were generated with green skin from the
start. Earlier generation prompts document the original versions.

All 72 PNGs retain the generator's 1254 x 1254 full-resolution output. Pixel-art styling does
...
Validation: all 72 PNGs decode, have unique file hashes, and correspond exactly
